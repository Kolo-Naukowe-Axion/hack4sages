...
OUTPUT_PATH = ROOT / "ariel_exobiome_architecture.png"
...
def render_diagram(output_path: Path = OUTPUT_PATH) -> Path:
    ...
    ax.text(
        0.03,
        0.975,
        "Ariel ExoBiome Notebook Architecture",
        fontsize=26,
        fontweight="bold",
        ha="left",
        va="top",
    ...
    ax.text(
        0.03,
        0.945,
        "Source: ariel/models/notebooks/ariel_exobiome.ipynb and models/ariel_quantum_regression/",
        fontsize=12,
        ha="left",
        va="top",
        color="#37474F",
