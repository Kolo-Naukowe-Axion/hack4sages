# Codex 8-Qubit Garnet Benchmark Report

## Overview

This report summarizes the completed benchmark run from `garnet_port_tutorial.ipynb` using the `8`-qubit Codex checkpoint:

- Checkpoint: `ariel/models/weights/ariel_codex_8.pt`
- Split: `validation`
- Evaluated rows: `2000`
...
The checkpoint metadata embedded in `ariel_codex_8.pt` reports:
