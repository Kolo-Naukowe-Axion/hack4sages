...
def default_data_root(project_root: Path) -> Path:
    candidate = project_root / "quantum_model_crossgen" / "crossgen_biosignatures_20260311"
    if candidate.exists():
        return candidate
...
def default_output_dir(project_root: Path) -> Path:
    return project_root / "outputs" / "model_crossgen"
...
class TrainingConfig:
    project_root: str = "."
    data_root: str = ""
    output_dir: str = "outputs/model_crossgen"
    seed: int = 42
