# Prepare exobiome_model for Training — Implementation Plan

> **For legacy_model:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Make exobiome_model understandable and trainable end-to-end on the crossgen_biosignatures dataset.
...
The working venv lives at `../quantum_model/.venv`. Symlink it so all commands work from `exobiome_model/`.

**Files:**
- Create: `exobiome_model/.venv` (symlink)

**Step 1: Create the symlink**

```bash
cd /Users/michalszczesny/projects/hack4sages/exobiome_model
...
### Task 3: Write legacy_model.md

**Files:**
- Create: `legacy_model.md`
