...
OUTPUT_ROOT="${OUTPUT_ROOT:-$PROJECT_ROOT/outputs/taurex_codex_without_quant_$(date +%Y%m%d_%H%M%S)}"
...
train_cmd=(
  "$PYTHON_BIN" -u "$PROJECT_ROOT/models/taurex_codex_without_quant/run_ariel_quantum_regression.py"
