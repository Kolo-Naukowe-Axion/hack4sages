...
OUTPUT_ROOT="${2:-${PROJECT_ROOT}/outputs/taurex_codex_without_quant_cv_two_stage}"
...
stage1_cmd=(
  "${PYTHON_BIN}" -u "${PROJECT_ROOT}/models/taurex_codex_without_quant/run_ariel_quantum_cross_validation.py"
