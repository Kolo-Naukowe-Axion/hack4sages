...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-dir", default="outputs/taurex_exobiome_without_quant")
...
def main() -> None:
    ...
    from models.taurex_exobiome_without_quant.training import TrainingConfig, run_training_experiment
