#!/usr/bin/env python3
"""Run k-fold cross-validation for the Ariel five-gas hybrid quantum regressor."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-dir", default="outputs/taurex_exobiome_without_quant_cv")
...
def main() -> None:
    ...
    from models.taurex_exobiome_without_quant.cross_validation import (
        CrossValidationConfig,
        aggregate_cross_validation_outputs,
        normalize_selected_folds,
        run_cross_validation_experiment,
    )
    from models.taurex_exobiome_without_quant.training import TrainingConfig
