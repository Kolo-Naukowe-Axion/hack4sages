...
PYTHON_BIN="${PYTHON_BIN:-$HOME/.venvs/five-qubit-codex/bin/python}"
DATA_ROOT="${1:-${PROJECT_ROOT}/data/ariel-ml-dataset}"
OUTPUT_ROOT="${2:-${PROJECT_ROOT}/outputs/five_qubit_codex_two_stage_$(date +%Y%m%d_%H%M%S)}"
...
stage1_cmd=(
  "${PYTHON_BIN}" -u "${PROJECT_ROOT}/models/five_qubit_codex/run_five_qubit_codex.py"
