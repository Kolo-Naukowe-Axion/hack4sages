#!/usr/bin/env python3
"""Run the Five-qubit Codex Ariel hybrid quantum regressor."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-dir", default="outputs/five_qubit_codex")
...
def main() -> None:
    ...
    from models.five_qubit_codex.training import TrainingConfig, run_training_experiment
