#!/usr/bin/env python3
"""Run k-fold cross-validation for the Five-qubit Codex Ariel hybrid quantum regressor."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-dir", default="outputs/five_qubit_codex_cv")
...
def main() -> None:
    ...
    from models.five_qubit_codex.cross_validation import CrossValidationConfig, run_cross_validation_experiment
    from models.five_qubit_codex.training import TrainingConfig
