#!/usr/bin/env python3
"""Run k-fold cross-validation for the Five-qubit ExoBiome Ariel hybrid quantum regressor."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-dir", default="outputs/five_qubit_exobiome_cv")
...
def main() -> None:
    ...
    from models.five_qubit_exobiome.cross_validation import CrossValidationConfig, run_cross_validation_experiment
    from models.five_qubit_exobiome.training import TrainingConfig
