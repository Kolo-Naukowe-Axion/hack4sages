"""Posterior-based evaluation and prediction export for TauREx-only five-gas FMPE runs."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Evaluate posterior mean/median regression metrics from a trained TauREx-only FMPE run."
    )
