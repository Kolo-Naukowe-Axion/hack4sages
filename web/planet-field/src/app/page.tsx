...
export default function HomePage() {
  ...
  return (
    <div ref={scrollRef} className="page-enter">
      {/* Hero — full-screen planet field background */}
      <section className="relative h-screen min-h-[600px] overflow-hidden">
        {/* Planet field fills the entire hero */}
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 pointer-events-none">
          <h1 className="reveal text-5xl md:text-7xl font-bold text-text leading-tight tracking-tight mb-4 text-center">
            <ShimmerText className="text-5xl md:text-7xl font-bold text-text" delay={2} duration={2}>
              ExoBiome
            </ShimmerText>
          </h1>
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={title}
              className="reveal bg-surface/80 border border-border rounded-lg p-5
