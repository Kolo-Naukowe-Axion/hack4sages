...
export default function HomePage() {
  ...
  return (
    <div ref={ref} className="max-w-[900px] mx-auto px-4 py-6 space-y-2 cell-stagger">
      ...
      {/* Cell 3: Output — project description */}
      <div className="reveal">
      ...
      {/* Cell 5: Output — biosignatures explanation */}
      <div className="reveal">
        <Cell type="output" executionCount={2}>
          <div className="space-y-3 text-[14px]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-3">
              <div className="border border-nb-border rounded p-3 bg-nb-code-bg">
      ...
      {/* Cell 7: Output — quantum explanation */}
      <div className="reveal">
        <Cell type="output" executionCount={3}>
          <div className="space-y-3 text-[14px]">
            ...
            <div className="font-mono text-[12px] bg-nb-code-bg p-3 rounded border border-nb-border leading-relaxed">
              <div className="text-nb-muted"># Pipeline architecture</div>
              ...
              <div className="mt-2 text-nb-muted"># Based on Vetrano et al. 2025 (arXiv:2509.03617)</div>
              <div className="text-nb-muted"># Hardware: Odra 5 (PWR Wroclaw) / VTT Q50 (Finland)</div>
            </div>
            <div className="flex items-center gap-2 text-nb-muted text-[13px]">
        ...
        <Cell type="markdown">
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <Link
                href="/explorer"
                className="flex-1 text-center px-4 py-3 bg-nb-blue text-white rounded font-mono text-[13px] hover:bg-blue-600 transition-colors"
              >
                Planet_Explorer.ipynb
              </Link>
              <Link
                href="/models"
                className="flex-1 text-center px-4 py-3 bg-nb-code-bg text-nb-text border border-nb-border rounded font-mono text-[13px] hover:bg-nb-hover transition-colors"
              >
...
function StatBlock({ value, label, sub }: { value: string; label: string; sub: string }) {
  return (
    <div className="text-center p-3 border border-nb-border rounded bg-nb-code-bg">
